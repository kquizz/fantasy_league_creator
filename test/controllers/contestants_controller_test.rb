...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference("Contestant.count") do
      post contestants_url, params: { contestant: { arrival_date: @contestant.arrival_date, birthdate: @contestant.birthdate, details: @contestant.details, image: @contestant.image, name: @contestant.name } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { arrival_date: @contestant.arrival_date, birthdate: @contestant.birthdate, details: @contestant.details, image: @contestant.image, name: @contestant.name } }
