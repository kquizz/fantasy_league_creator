...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference("League.count") do
      post leagues_url, params: { league: { commissioner_id: @league.commissioner_id, event_id: @league.event_id, name: @league.name } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { commissioner_id: @league.commissioner_id, event_id: @league.event_id, name: @league.name } }
